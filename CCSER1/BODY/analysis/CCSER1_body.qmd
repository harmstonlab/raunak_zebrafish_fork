...
Raunak's original code reads in a body_metadata.csv file, but I can't find it. We create it manually. 
```{r}
...
write.csv(comb, paste0(output_dir, "CCSER1_annotated_genes.csv"))
```
...
write.csv(temp, paste0(output_dir, "S_unique.csv"))
...
write.csv(temp, paste0(output_dir, "M_unique.csv"))
...
write.csv(temp, paste0(output_dir, "MvsS_unique.csv"))
...
write.csv(temp, paste0(output_dir, "S_M_intersect.csv"))
...
write.csv(temp, paste0(output_dir, "M_MvsS_intersect.csv"))
...
write.csv(temp, paste0(output_dir, "S_MvsS_intersect.csv"))
...
write.csv(temp, paste0(output_dir, "All_intersect.csv"))
...
tmp2 = cbind(ann, tmp)
write.csv(tmp2, paste0(output_dir, "S_vs_WT.csv"))
